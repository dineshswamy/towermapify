...
url="http://localhost:3000/gen_kml/generatekml.xml?reg_id=12";
InspectCheckBox();
...
{
var c=document.selectregion.regionid.value;
url="";
url="http://localhost:3000/gen_kml/generatekml.xml?reg_id="+c;
DoQuery();
}
